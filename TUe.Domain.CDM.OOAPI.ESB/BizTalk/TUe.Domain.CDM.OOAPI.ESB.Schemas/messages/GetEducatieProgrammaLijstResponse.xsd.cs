namespace TUe.Domain.CDM.OOAPI.ESB.Schemas.messages {
    ...
    [Schema(@"http://TUe.Domain.CDM.OOAPI.Messages/EducatieProgrammaLijst/1.0",@"EducationalPrograms")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"EducationalPrograms"})]
    public sealed class GetEducatieProgrammaLijstResponse : Microsoft.XLANGs.BaseTypes.SchemaBase {
  ...
  <xs:element name=""EducationalPrograms"">
    <xs:complexType>
      <xs:sequence>
        ...
        public GetEducatieProgrammaLijstResponse() {
        }
