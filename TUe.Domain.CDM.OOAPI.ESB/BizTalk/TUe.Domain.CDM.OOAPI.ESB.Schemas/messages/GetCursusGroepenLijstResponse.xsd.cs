namespace TUe.Domain.CDM.OOAPI.ESB.Schemas.messages {
    ...
    [Schema(@"http://TUe.Domain.CDM.OOAPI.Messages/CursusGroepenLijst/1.0",@"CourseGroups")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"CourseGroups"})]
    public sealed class GetCursusGroepenLijstResponse : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns=""http://TUe.Domain.CDM.OOAPI.Messages/CursusGroepenLijst/1.0"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" attributeFormDefault=""unqualified"" elementFormDefault=""unqualified"" targetNamespace=""http://TUe.Domain.CDM.OOAPI.Messages/CursusGroepenLijst/1.0"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""CourseGroups"">
    <xs:complexType>
      <xs:sequence>
        ...
        public GetCursusGroepenLijstResponse() {
        }
